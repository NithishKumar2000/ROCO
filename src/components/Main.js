          ...
          <div id='content' className='mt-3'>
              ...
              <div className='card mb-2' style={{opacity:'0,9'}}>
                  ...
                  onSubmit={(event)=>{
                      ...
                      let amount=this.colorinput.value.toString()
                      amount=window.web3.utils.ether.toWei(amount,'Ether')
                      this.props.stakeTokens(amount)
                  }}
                  className='mb-3'>
                    <div style={{borderSpacing :'0 1em'}}>
                        <label className='float-left' style={{marginLeft:'15px'}}><b>Stake Tokens</b></label>
                        <span className='float-right' style={{marginLeft:'8px'}}>Balance:
                        {window.web3.utils.fromWei(this.props.tetherBalance,'Ether')}
                        </span>
                        <div className='input-group mb-4'>
                            <input type='text' placeholder='0' required />
                            <div className='input-group-open'>
                                <img src={tether} height='40' />
                                &nbsp;&nbsp;&nbsp; USDT
                            </div>
                        </div>
